...
pub mod _bindgen_ty_1 {
    pub type Type = i32;
    pub const JS_TAG_FIRST: Type = -10;
    pub const JS_TAG_BIG_INT: Type = -10;
    pub const JS_TAG_BIG_FLOAT: Type = -9;
    pub const JS_TAG_SYMBOL: Type = -8;
    pub const JS_TAG_STRING: Type = -7;
    pub const JS_TAG_SHAPE: Type = -6;
    pub const JS_TAG_ASYNC_FUNCTION: Type = -5;
    pub const JS_TAG_VAR_REF: Type = -4;
    pub const JS_TAG_MODULE: Type = -3;
    pub const JS_TAG_FUNCTION_BYTECODE: Type = -2;
    pub const JS_TAG_OBJECT: Type = -1;
    pub const JS_TAG_INT: Type = 0;
    pub const JS_TAG_BOOL: Type = 1;
    pub const JS_TAG_NULL: Type = 2;
    pub const JS_TAG_UNDEFINED: Type = 3;
    pub const JS_TAG_UNINITIALIZED: Type = 4;
    pub const JS_TAG_CATCH_OFFSET: Type = 5;
    pub const JS_TAG_EXCEPTION: Type = 6;
    pub const JS_TAG_FLOAT64: Type = 7;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub mod JSCFunctionEnum {
    pub type Type = u32;
    pub const JS_CFUNC_generic: Type = 0;
    pub const JS_CFUNC_generic_magic: Type = 1;
    pub const JS_CFUNC_constructor: Type = 2;
    pub const JS_CFUNC_constructor_magic: Type = 3;
    pub const JS_CFUNC_constructor_or_func: Type = 4;
    pub const JS_CFUNC_constructor_or_func_magic: Type = 5;
    pub const JS_CFUNC_f_f: Type = 6;
    pub const JS_CFUNC_f_f_f: Type = 7;
    pub const JS_CFUNC_getter: Type = 8;
    pub const JS_CFUNC_setter: Type = 9;
    pub const JS_CFUNC_getter_magic: Type = 10;
    pub const JS_CFUNC_setter_magic: Type = 11;
    pub const JS_CFUNC_iterator_next: Type = 12;
}
#[repr(C)]
#[derive(Copy, Clone)]
